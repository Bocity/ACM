//#include<bits/stdc++.h>
//using namespace std;
//const int eps = 1e-10, pi = acos(-1.0);
...
//    for(int i=0;i<4;i++)
//    {
//        if(jz[a].p[0].x<=jz[b].p[i].x&&jz[a].p[])
//    }
//}
...
bool check(int a,int b)
{
    ...
    if(
        ...
        ||SegmentProperIntersection(jz[a].p[1],jz[a].p[3],jz[b].p[0],jz[b].p[1])
        ||SegmentProperIntersection(jz[a].p[1],jz[a].p[3],jz[b].p[0],jz[b].p[2])
        ||SegmentProperIntersection(jz[a].p[1],jz[a].p[3],jz[b].p[2],jz[b].p[3])
        ||SegmentProperIntersection(jz[a].p[1],jz[a].p[3],jz[b].p[1],jz[b].p[3])

        ||SegmentProperIntersection(jz[a].p[2],jz[a].p[3],jz[b].p[0],jz[b].p[1])
        ||SegmentProperIntersection(jz[a].p[2],jz[a].p[3],jz[b].p[0],jz[b].p[2])
        ||SegmentProperIntersection(jz[a].p[2],jz[a].p[3],jz[b].p[2],jz[b].p[3])
        ||SegmentProperIntersection(jz[a].p[2],jz[a].p[3],jz[b].p[1],jz[b].p[3]))
        return 0;
    else
        return 1;
...
{
    if(jz[a].p[0].x<jz[b].p[0].x&&jz[a].p[0].y<jz[b].p[0].y&&jz[a].p[3].x>jz[b].p[0].x&&jz[a].p[3].y>jz[b].p[0].y)
        return 1;
}
long long getans(int a,int b)
{
...
{
    int ans1=0;
    ans1=max(ans1,abs(jz[a].p[0].x-jz[a].p[3].x)*abs(jz[a].p[0].y-jz[a].p[3].y));
    ans1=max(ans1,abs(jz[b].p[0].x-jz[b].p[3].x)*abs(jz[b].p[0].y-jz[b].p[3].y));
    return ans1;
}
int mapp[205][205];
int main()

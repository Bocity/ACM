...
{
    if(jz[a].p[0].x<=jz[b].p[0].x&&jz[a].p[0].y<=jz[b].p[0].y
            &&
            jz[a].p[3].x>=jz[b].p[0].x&&jz[a].p[3].y>=jz[b].p[0].y
      )
    {
        if(jz[a].p[0].x<jz[b].p[3].x&&jz[a].p[0].y<jz[b].p[3].y&&
           jz[a].p[3].x>jz[b].p[3].x&&jz[a].p[3].y>jz[b].p[3].y&&
           jz[a].p[0].x<jz[b].p[0].x&&jz[a].p[0].y<jz[b].p[0].y&&
            jz[a].p[3].x>jz[b].p[0].x&&jz[a].p[3].y>jz[b].p[0].y
           )
            return 1;
        else
